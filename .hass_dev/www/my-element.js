import { css as w, LitElement as P, html as U } from "lit";
const C = (i) => (t, e) => {
  e !== void 0 ? e.addInitializer(() => {
    customElements.define(i, t);
  }) : customElements.define(i, t);
};
const d = globalThis, m = d.ShadowRoot && (d.ShadyCSS === void 0 || d.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, v = /* @__PURE__ */ Symbol(), _ = /* @__PURE__ */ new WeakMap();
let O = class {
  constructor(t, e, s) {
...
const { is: R, defineProperty: x, getOwnPropertyDescriptor: k, getOwnPropertyNames: j, getOwnPropertySymbols: z, getPrototypeOf: T } = Object, u = globalThis, b = u.trustedTypes, D = b ? b.emptyScript : "", L = u.reactiveElementPolyfillSupport, c = (i, t) => i, p = { toAttribute(i, t) {
  switch (t) {
    case Boolean:
      i = i ? D : null;
      break;
  ...
  return e;
} }, y = (i, t) => !R(i, t), E = { attribute: !0, type: String, converter: p, reflect: !1, useDefault: !1, hasChanged: y };
...
class h extends HTMLElement {
  ...
  static getPropertyDescriptor(t, e, s) {
    const { get: r, set: o } = k(this.prototype, t) ?? { get() {
      return this[e];
    }, set(n) {
      this[e] = n;
    } };
...
const q = { attribute: !0, type: String, converter: p, reflect: !1, hasChanged: y }, N = (i = q, t, e) => {
...
var H = Object.defineProperty, B = Object.getOwnPropertyDescriptor, $ = (i, t, e, s) => {
  for (var r = s > 1 ? void 0 : s ? B(t, e) : t, o = i.length - 1, n; o >= 0; o--)
